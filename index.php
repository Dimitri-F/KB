...
?>
  ...
  <section class="hero">
    ...
    <img src="assets/photos/photo-accueil.webp" alt="">
      ...
      <div class="quick-grid">
        ...
        <a href="emplacements.html">
          <div class="quick-card">
            <img src="assets/photos/photo-emplacement.webp" alt="Emplacements food">
        ...
        <a href="carte.html">
          <div class="quick-card">
            <img src="assets/photos/photo-notre-carte.webp" alt="Menu KB">
            <div class="quick-card-content">
              <h3>Notre carte</h3>
              <p>
        ...
        <a href="horaires.html">
          <div class="quick-card">
            <img src="assets/photos/photo-horaire.png" alt="Horaires KB">
            <div class="quick-card-content">
              <h3>Nos horaires</h3>
              <p>
  ...
  <section>
    ...
    <div class="container story">
      ...
      <div class="story-text">
        ...
        <div class="hero-buttons">
          <a href="concept.html" class="btn-primary">En savoir plus</a>
        </div>
      ...
      <div class="story-image">
        <img src="assets/photos/photo-concept-accueil.webp" alt="Produits KB">
      </div>
      ...
      <div class="gallery-wrapper">
        ...
        <div class="gallery-carousel">
          ...
          <div class="gallery-slide">
            <img src="/assets/photos/photo-galerie-1.webp" alt="">
          </div>

          <div class="gallery-slide">
            <img src="/assets/photos/photo-galerie-2.webp" alt="">
          </div>

          <div class="gallery-slide">
            <img src="/assets/photos/photo-galerie-3.webp" alt="">
          </div>

          <div class="gallery-slide">
            <img src="/assets/photos/photo-galerie-4.webp" alt="">
          </div>

          <div class="gallery-slide">
            <img src="/assets/photos/photo-galerie-5.webp" alt="">
          </div>

          <div class="gallery-slide">
            <img src="/assets/photos/photo-galerie-6.webp" alt="">
          </div>

          <div class="gallery-slide">
            <img src="/assets/photos/photo-galerie-7.webp" alt="">
          </div>

          <div class="gallery-slide">
            <img src="/assets/photos/photo-galerie-8.webp" alt="">
          </div>

          <div class="gallery-slide">
            <img src="/assets/photos/photo-galerie-9.webp" alt="">
          </div>

          <div class="gallery-slide">
            <img src="/assets/photos/photo-galerie-10.webp" alt="">
          </div>
  ...
  <section>
    ...
    <div class="container">
      ...
      <div class="private">
        ...
        <img src="/assets/photos/photo-privatisation.webp" alt="Privatisation KB">
        ...
        <div class="private-content">
          ...
          <div class="private-inner">
            ...
            <a href="privatisation.php" class="btn-primary">
              Nous contacter
            </a>
    ...
    <div class="container reassurance">
      ...
      <div class="container story">
        ...
        <div class="reassurance-image">
          <img src="assets/photos/fournisseurs.png" alt="Produits KB">
        </div>
